                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             ") Exceed The Max Parser Limit: name=\"",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             ::fast_io::mnp::code_cvt(errout.err.err_selectable.exceed_the_max_parser_limit.name),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             "\", value=",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.err.err_selectable.exceed_the_max_parser_limit.value,
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             " > limit=",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.err.err_selectable.exceed_the_max_parser_limit.maxval,
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             ".",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             L"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             L") Exceed The Max Parser Limit: name=\"",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             ::fast_io::mnp::code_cvt(errout.err.err_selectable.exceed_the_max_parser_limit.name),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             L"\", value=",
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u8"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             u8") Exceed The Max Parser Limit: name=\"",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             // Same type, no conversion required
                                                             errout.err.err_selectable.exceed_the_max_parser_limit.name,
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u8"\", value=",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             errout.err.err_selectable.exceed_the_max_parser_limit.value,
                 ...
                 ::std::same_as<::std::remove_cvref_t<Stm>, ::fast_io::basic_zw_io_observer<char_type>>)
    {
        if(static_cast<bool>(errout.flag.win32_use_text_attr) && enable_ansi)
        {
            ::fast_io::operations::print_freestanding<false>(::std::forward<Stm>(stream),
                                                             ...
                                                             u"(offset=",
                                                             ::fast_io::mnp::addrvw(errout.err.err_curr - errout.module_begin),
                                                             u") Exceed The Max Parser Limit: name=\"",
                                                             UWVM_WIN32_TEXTATTR_CYAN,
                                                             ::fast_io::mnp::code_cvt(errout.err.err_selectable.exceed_the_max_parser_limit.name),
                                                             UWVM_WIN32_TEXTATTR_WHITE,
                                                             u"\", value=",
