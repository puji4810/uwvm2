...
{
    /// @brief     WasiPreview1.fd_seek_wasm64
    ...
    inline ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t fd_seek_wasm64(
        ...
        ::uwvm2::imported::wasi::wasip1::abi::wasi_void_ptr_wasm64_t new_offset_ptrsz) noexcept
    {
        ...
        if(trace_wasip1_call) [[unlikely]]
        {
            ...
            ::fast_io::io::perr(::fast_io::u8err(),
                                u8"uwvm: [info]  wasip1: fd_seek_wasm64(",
                                fd,
                                u8", ",
                                static_cast<::std::underlying_type_t<::std::remove_cvref_t<decltype(offset)>>>(offset),
                                u8", ",
        ...
        if((curr_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_wasm64_t::right_fd_seek) !=
...
// This will be checked at runtime.
        ...
        switch(whence)
        {
            case ::uwvm2::imported::wasi::wasip1::abi::whence_wasm64_t::whence_set:
            {
                seek_whence = ::fast_io::seekdir::beg;
                break;
            }
            case ::uwvm2::imported::wasi::wasip1::abi::whence_wasm64_t::whence_cur:
            {
                seek_whence = ::fast_io::seekdir::cur;
                break;
            }
            case ::uwvm2::imported::wasi::wasip1::abi::whence_wasm64_t::whence_end:
            {
        ...
        {
            if(underlying_offset > ::std::numeric_limits<::fast_io::intfpos_t>::max())
            {
