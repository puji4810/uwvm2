...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    /// *nwritten);
    inline ::uwvm2::imported::wasi::wasip1::abi::errno_t fd_pwrite(
        ...
        ::uwvm2::imported::wasi::wasip1::abi::wasi_void_ptr_t nwritten) noexcept
    {
        ...
        if(((curr_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_fd_write) !=
            ::uwvm2::imported::wasi::wasip1::abi::rights_t::right_fd_write) ||
...
// This will be checked at runtime.
        ...
        ::uwvm2::imported::wasi::wasip1::memory::check_memory_bounds_wasm32(memory,
                                                                            iovs,
                                                                            iovs_len * ::uwvm2::imported::wasi::wasip1::abi::size_of_wasi_ciovec_t);
...
# endif
            ...
            ::uwvm2::imported::wasi::wasip1::memory::store_basic_wasm_type_to_memory_wasm32_unlocked(
                memory,
                nwritten,
                static_cast<::uwvm2::imported::wasi::wasip1::abi::wasi_size_t>(total_bytes_write));
