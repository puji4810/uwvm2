...
#endif
        {
            // fast_io's native_mkdir creates new paths according to system rules, and nearly all systems will refuse to create paths recursively.
            ::fast_io::native_mkdirat(at(curr_fd_native_file), path);
        }
#ifdef UWVM_CPP_EXCEPTIONS
