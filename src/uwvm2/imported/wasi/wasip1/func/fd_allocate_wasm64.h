        ...
        ::uwvm2::imported::wasi::wasip1::abi::filesize_wasm64_t len) noexcept
    {
        ...
        if(trace_wasip1_call) [[unlikely]]
        {
            ...
            ::fast_io::io::perr(::fast_io::u8err(),
                                u8"uwvm: [info]  wasip1: fd_allocate_wasm64(",
                                fd,
                                u8", ",
                                static_cast<::std::underlying_type_t<::std::remove_cvref_t<decltype(offset)>>>(offset),
                                u8", ",
        ...
        if((curr_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_wasm64_t::right_fd_allocate) !=
           ::uwvm2::imported::wasi::wasip1::abi::rights_wasm64_t::right_fd_allocate) [[unlikely]]
        {
...
// This will be checked at runtime.
        ...
        if(static_cast<underlying_filesize_t>(len) == 0u) [[unlikely]] { return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::esuccess; }
        ...
        if(::uwvm2::imported::wasi::wasip1::func::posix::fcntl(curr_fd_native_handle, F_PREALLOCATE, ::std::addressof(fstore)) == -1) [[unlikely]]
        {
            ...
            if(::uwvm2::imported::wasi::wasip1::func::posix::fcntl(curr_fd_native_handle, F_PREALLOCATE, ::std::addressof(fstore)) == -1) [[unlikely]]
            {
                ...
                switch(errno)
                {
                    ...
                    case EISDIR: return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::eio;
...
# elif !defined(_WIN32_WINNT) || _WIN32_WINNT >= 0x600
           ...
           status) [[unlikely]]
        {
            switch(status)
            {
                case 0xC000007Fu /*STATUS_DISK_FULL*/: return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::enospc;
                ...
                // The `dir` is managed as a separate virtual file system. If encountered here, it indicates a virtual machine issue.
                case 0xC00000BAu /*STATUS_FILE_IS_A_DIRECTORY*/: return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::eio;
                default: return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::eio;
            }
        }
