...
UWVM_MODULE_EXPORT namespace uwvm2::imported::wasi::wasip1::func
{
    ...
    ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t fd_filestat_set_size_wasm64(
        ...
        ::uwvm2::imported::wasi::wasip1::abi::filesize_wasm64_t size) noexcept
    {
        ...
        if(trace_wasip1_call) [[unlikely]]
        {
            ...
            ::fast_io::io::perr(::uwvm2::uwvm::io::u8log_output,
                                ...
                                u8"fd_filestat_set_size_wasm64",
                                ::fast_io::mnp::cond(::uwvm2::uwvm::utils::ansies::put_color, UWVM_COLOR_U8_WHITE),
                                u8"(",
                                ::fast_io::mnp::cond(::uwvm2::uwvm::utils::ansies::put_color, UWVM_COLOR_U8_LT_GREEN),
                                fd,
            ...
            ::fast_io::io::perr(::fast_io::u8err(),
                                u8"uwvm: [info]  wasip1: fd_filestat_set_size_wasm64(",
                                fd,
                                u8", ",
                                static_cast<::std::underlying_type_t<::std::remove_cvref_t<decltype(size)>>>(size),
                                u8") (wasi-trace)\n");
        ...
        if((curr_fd.rights_base & ::uwvm2::imported::wasi::wasip1::abi::rights_wasm64_t::right_fd_filestat_set_size) !=
           ::uwvm2::imported::wasi::wasip1::abi::rights_wasm64_t::right_fd_filestat_set_size) [[unlikely]]
        {
                    ...
                    switch(e.domain)
                    {
                        case ::fast_io::win32_domain_value:
                        {
                            switch(e.code)
                            {
                                ...
                                case 39uz /*ERROR_HANDLE_DISK_FULL*/: return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::enospc;
                                case 223uz /*ERROR_FILE_TOO_LARGE*/: return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::efbig;
                                case 1295uz /*ERROR_DISK_QUOTA_EXCEEDED*/: return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::edquot;
...
# if !defined(_WIN32_WINDOWS)
                        case ::fast_io::nt_domain_value:
                        {
                            ...
                            switch(e.code)
                            {
                                ...
                                case 0xC0000904uz /*STATUS_FILE_TOO_LARGE*/: return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::efbig;
                                case 0xC0000044uz /*STATUS_QUOTA_EXCEEDED*/: return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::edquot;
                                default: return ::uwvm2::imported::wasi::wasip1::abi::errno_wasm64_t::eio;
                            }
                        }
# endif
