...
int main()
{
    ...
    {
        auto const ret = ::uwvm2::imported::wasi::wasip1::func::fd_renumber_wasm64(env, static_cast<wasi_posix_fd_wasm64_t>(-1), static_cast<wasi_posix_fd_wasm64_t>(0));
    ...
    // Case 1: same fd (valid) -> esuccess
    {
        ...
        auto const ret = ::uwvm2::imported::wasi::wasip1::func::fd_renumber_wasm64(env, static_cast<wasi_posix_fd_wasm64_t>(1), static_cast<wasi_posix_fd_wasm64_t>(1));
    ...
    // Case 2: from in opens (active), to in opens (to is closed) -> replace closed slot and fix closes indices
    {
        ...
        auto const ret = ::uwvm2::imported::wasi::wasip1::func::fd_renumber_wasm64(env, static_cast<wasi_posix_fd_wasm64_t>(2), static_cast<wasi_posix_fd_wasm64_t>(3));
        if(ret != errno_wasm64_t::esuccess)
        {
    ...
    // Case 3: from in opens (active), to in opens (to is active) -> wait and replace, delayed destroy
    {
        ...
        auto const ret = ::uwvm2::imported::wasi::wasip1::func::fd_renumber_wasm64(env, static_cast<wasi_posix_fd_wasm64_t>(4), static_cast<wasi_posix_fd_wasm64_t>(5));
        if(ret != errno_wasm64_t::esuccess)
        {
