...
int main()
{
    ...
    {
        auto const ret =
            ::uwvm2::imported::wasi::wasip1::func::fd_filestat_set_size_wasm64(env, static_cast<wasi_posix_fd_wasm64_t>(-1), static_cast<filesize_wasm64_t>(0));
    ...
    // Case 3: ebadf after fd_close
    {
        ...
        fde.wasi_fd.ptr->wasi_fd_storage.storage
            ...
            .file
#endif
            = ::fast_io::native_file{u8"test_fd_filestat_set_size_wasm64_close.tmp",
                                     ::fast_io::open_mode::out | ::fast_io::open_mode::trunc | ::fast_io::open_mode::creat};
