...
int main()
{
    ...
    // Case 1: enotcapable when rights do not include right_fd_datasync
    {
        ...
        fd1.wasi_fd.ptr->wasi_fd_storage.storage.file_fd
            ...
            .file
#endif
            = ::fast_io::native_file{u8"test_fd_datasync64.tmp", ::fast_io::open_mode::out};
    ...
    // Case 2: esuccess when rights ok and fd valid
    {
        ...
        fd3.wasi_fd.ptr->wasi_fd_storage.storage.file_fd
            ...
            .file
#endif
            = ::fast_io::native_file{u8"test_fd_datasync64_ok.tmp", ::fast_io::open_mode::out};
    ...
    // Case 4: ebadf after fd has been closed
    {
        ...
        fd2.wasi_fd.ptr->wasi_fd_storage.storage.file_fd
            ...
            .file
#endif
            = ::fast_io::native_file{u8"test_fd_close_then_datasync64.tmp", ::fast_io::open_mode::out};
