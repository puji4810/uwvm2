...
int main()
{
    ...
    fd4.wasi_fd.ptr->wasi_fd_storage.storage
        ...
        .file
#endif
        = ::fast_io::native_file{u8"test_fd_fdstat_set_rights.tmp", ::fast_io::open_mode::out | ::fast_io::open_mode::creat | ::fast_io::open_mode::trunc};
    ...
    auto read_rights = [&](wasi_posix_fd_t fd, rights_t& out_base, rights_t& out_inh)
    {
        ...
        u_rights const base_u =
            ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm32<u_rights>(memory, static_cast<wasi_void_ptr_t>(stat_ptr + 8u));
        u_rights const inh_u =
            ::uwvm2::imported::wasi::wasip1::memory::get_basic_wasm_type_from_memory_wasm32<u_rights>(memory, static_cast<wasi_void_ptr_t>(stat_ptr + 16u));
    ...
    // Case 3: attempt to increase base (should be enotcapable)
    {
        ...
        auto const ret = ::uwvm2::imported::wasi::wasip1::func::fd_fdstat_set_rights(env, static_cast<wasi_posix_fd_t>(4), new_base, curr_inh);
    ...
    // Case 4: attempt to increase inheriting (should be enotcapable)
    {
        ...
        rights_t const new_inh =
            static_cast<rights_t>(static_cast<::std::underlying_type_t<rights_t>>(curr_inh) | static_cast<::std::underlying_type_t<rights_t>>(inc_inh));
        auto const ret = ::uwvm2::imported::wasi::wasip1::func::fd_fdstat_set_rights(env, static_cast<wasi_posix_fd_t>(4), curr_base, new_inh);
        if(ret != errno_t::enotcapable)
        {
    ...
    // Case 5: inheriting may contain bits that base does not (allowed by spec)
    {
        ...
        fd5.wasi_fd.ptr->wasi_fd_storage.storage
            ...
            .file
#endif
            = ::fast_io::native_file{u8"test_fd_fdstat_set_rights_case5.tmp",
    ...
    // Case 6: ebadf after fd_close
    {
        ...
        fde.wasi_fd.ptr->wasi_fd_storage.storage
            ...
            .file
#endif
            = ::fast_io::native_file{u8"test_fd_fdstat_set_rights_close.tmp",
                                     ::fast_io::open_mode::out | ::fast_io::open_mode::creat | ::fast_io::open_mode::trunc};
