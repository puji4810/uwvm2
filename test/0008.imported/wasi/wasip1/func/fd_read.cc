...
// no third-party test headers
 ...
 int main()
 {
     ...
     // Case 1: regular file read two buffers from beginning; prepare content by pwrite
     {
         ...
         fde.file_fd = ::fast_io::native_file{u8"test_fd_read_regular.tmp",
         ...
         ::uwvm2::imported::wasi::wasip1::memory::store_basic_wasm_type_to_memory_wasm32(memory,
                                                                                         static_cast<wasi_void_ptr_t>(wiovs_ptr + 8u),
                                                                                         wbuf2);
         ::uwvm2::imported::wasi::wasip1::memory::store_basic_wasm_type_to_memory_wasm32(memory,
         ...
         ::uwvm2::imported::wasi::wasip1::memory::store_basic_wasm_type_to_memory_wasm32(memory, iovs_ptr,
                                                                                         static_cast<wasi_void_ptr_t>(rbuf1));
         ::uwvm2::imported::wasi::wasip1::memory::store_basic_wasm_type_to_memory_wasm32(memory,
     ...
     // Case 2: zero iovecs → success, nread=0
     {
         ...
         fde.rights_base = static_cast<rights_t>(-1);
         fde.rights_inherit = static_cast<rights_t>(-1);
         fde.file_fd = ::fast_io::native_file{u8"test_fd_read_zero.tmp",
                                             ::fast_io::open_mode::out | ::fast_io::open_mode::in |
                                                 ::fast_io::open_mode::trunc | ::fast_io::open_mode::creat};
     ...
     // Case 3: enotcapable when no read rights
     {
         ...
         // rights default 0
         fde.file_fd = ::fast_io::native_file{u8"test_fd_read_rights.tmp",
                                              ::fast_io::open_mode::out | ::fast_io::open_mode::in |
                                                  ::fast_io::open_mode::trunc | ::fast_io::open_mode::creat};
